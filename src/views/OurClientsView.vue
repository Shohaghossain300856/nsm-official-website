...
const allClients = [
  ...
  { id: 'rpmc',      name: 'Rangpur Medical College',           category: 'medical',    industry: 'Government Medical College',             system: 'Academic Management System',          systemIcon: '🎓', systemIconImg: '/images/icons/system-academic.svg', systemColor: '#894B9E', location: 'Rangpur Division',        status: 'Live Production', region: 'BD'  },
  { id: 'dinajpur',  name: 'Dinajpur Medical College',          category: 'medical',    industry: 'Government Medical College',             system: 'Academic Management System',          systemIcon: '🎓', systemIconImg: '/images/icons/system-academic.svg', systemColor: '#0D9488', location: 'Dinajpur, Rangpur',       status: 'Live Production', region: 'BD'  },
  { id: 'comilla',   name: 'Comilla Medical College',           category: 'medical',    industry: 'Government Medical College',             system: 'Academic Management System',          systemIcon: '🎓', systemIconImg: '/images/icons/system-academic.svg', systemColor: '#E11D48', location: 'Cumilla, Chittagong',     status: 'Live Production', region: 'BD'  },
  { id: 'satkhira',  name: 'Satkhira Medical College',          category: 'medical',    industry: 'Government Medical College',             system: 'Academic Management System',          systemIcon: '🎓', systemIconImg: '/images/icons/system-academic.svg', systemColor: '#4F46E5', location: 'Satkhira, Khulna',        status: 'Live Production', region: 'BD'  },
  ...
  { id: 'bogura',    name: 'Bogura Medical College',            category: 'medical',    industry: 'Government Medical College',             system: 'Academic Management System',          systemIcon: '🎓', systemIconImg: '/images/icons/system-academic.svg', systemColor: '#D97706', location: 'Bogura, Rajshahi',        status: 'Live Production', region: 'BD'  },
  { id: 'nilphamari',name: 'Nilphamari Medical College',        category: 'medical',    industry: 'Government Medical College',             system: 'Academic Management System',          systemIcon: '🎓', systemIconImg: '/images/icons/system-academic.svg', systemColor: '#0891B2', location: 'Nilphamari, Rangpur',     status: 'Live Production', region: 'BD'  },
  { id: 'baiust',    name: 'Bangladesh Army Int. University',   category: 'defense',    industry: 'Military & Defense University',          system: 'Internship & Industrial Training',    systemIcon: '🎖️', systemIconImg: '/images/icons/system-training.svg', systemColor: '#7C3AED', location: 'Saidpur, Nilphamari',     status: 'Verified Partner', region: 'BD' },
  ...
  { id: 'prime',     name: 'Prime Medical College',             category: 'medical',    industry: 'Private Medical College',                system: 'Medical Journal & DOI Portal',        systemIcon: '📑', systemIconImg: '/images/icons/system-journal.svg',  systemColor: '#BE123C', location: 'Rangpur City',            status: 'Live Production', region: 'BD'  },
  { id: 'sufi',      name: 'Sufi Group & Properties',           category: 'enterprise', industry: 'Industrial & Real Estate Conglomerate',  system: 'Corporate ERP & Real Estate',         systemIcon: '🏢', systemIconImg: '/images/icons/system-erp.svg',      systemColor: '#4338CA', location: 'Rangpur City',            status: 'Enterprise Hub', region: 'BD'   },
