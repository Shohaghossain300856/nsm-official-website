    ...
    <section class="page-banner">
      <div class="container">
        <div class="breadcrumb" style="margin-bottom: 1rem;">
          <router-link to="/">Home</router-link> &gt; <router-link to="/products">Products</router-link> &gt; <span>Inventory Management ERP</span>
        </div>
        <h1 class="section-title" style="margin-top: 1rem; margin-bottom: 1.25rem;">
          Inventory <span class="text-gradient">Management ERP</span>
        </h1>
        <p class="section-subtitle" style="max-width: 760px; line-height: 1.8;">
          Real-time multi-warehouse stock management, procurement workflows, barcode scanning, and financial accounting ledger integration.
        </p>
      </div>
    </section>
    ...
    <section class="section-padding" style="background: #FFFFFF;">
      <div class="container">
        <div class="detail-grid">
          <div>
            <span class="region-pill">SUPPLY CHAIN & WAREHOUSE ERP</span>
            <h2 class="region-title">Total Stock & Multi-Location Visibility</h2>
            <p class="region-desc" style="margin-bottom: 2rem;">
              The <strong>Inventory Management ERP by NSM Limited</strong> tracks stock movement across multi-tier warehouses, automating supplier purchase orders (PO), barcode/RFID lot scanning, sales dispatching, reorder thresholds, and general ledger syncing.
            </p>
          ...
          <div class="sidebar-cta-card">
            ...
            <form @submit.prevent="handleDemoSubmit">
              <div class="form-group">
                ...
                <input type="text" v-model="form.company" class="form-input" required>
              </div>
              <div class="form-group">
              ...
              <div v-if="submitted" style="margin-bottom: 1rem; padding: 0.5rem; background: rgba(16, 185, 129, 0.2); border: 1px solid #10B981; border-radius: 6px; color: #34D399; font-size: 0.85rem; font-weight: 600;">
                ✓ Demo request received! Our engineer will call you shortly.
              </div>

              <button type="submit" class="btn btn-primary btn-lg btn-pulse" style="width: 100%;">Book Inventory Demo ⚡</button>
            </form>
          </div>
        </div>
      </div>
        ...
        <div class="global-cta-banner" style="background: linear-gradient(135deg, #0F172A 0%, #1E1B4B 60%, #881337 100%);">
          <div class="global-cta-content">
            <div class="global-cta-badges">
              <span class="global-cta-badge">📦 Supply Chain ERP</span>
              <span class="global-cta-badge">⚡ Real-time Multi-Warehouse Sync</span>
            </div>
            <h2>Scale Your Warehouse and Supply Chain Today</h2>
            <p>Get accurate stock control, automated purchase orders, and multi-branch inventory tracking.</p>
          </div>
          <div class="global-cta-actions">
            ...
            <router-link to="/contact" class="btn btn-primary btn-lg" style="background: linear-gradient(135deg, #E11D48 0%, #4B53C6 100%);">Request Custom Quotation</router-link>
          </div>
        </div>
      </div>
    </section>
